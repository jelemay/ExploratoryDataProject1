...
#Second dual plot
with(dtf3[dtf3$Date < upper,], plot(Time,Voltage, type="n",xlab="Thursday"))
with(dtf3[dtf3$Date < upper,], lines(Time,Voltage,type="l"))
with(dtf3[dtf3$Date == upper,], plot(Time,Voltage, type="n",xlab="Friday"))
with(dtf3[dtf3$Date ==upper,], lines(Time,Voltage,type="l"))
...
# Fourth dual plot
with(dtf3[dtf3$Date < upper,], plot(Time,Global_reactive_power, type="n",xlab="Thursday"))
with(dtf3[dtf3$Date < upper,], lines(Time,Global_reactive_power,type="l"))
with(dtf3[dtf3$Date == upper,], plot(Time,Global_reactive_power, type="n",xlab="Friday"))
with(dtf3[dtf3$Date ==upper,], lines(Time,Global_reactive_power,type="l"))
